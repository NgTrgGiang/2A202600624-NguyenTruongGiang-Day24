...
def segment_vietnamese(text: str) -> str:
    ...
    try:
        ...
        return text  # fallback nếu underthesea lỗi/không có
...
class BM25Search:
    ...
    def search(self, query: str, top_k: int = BM25_TOP_K) -> list[SearchResult]:
        ...
        for i in top_indices:
            if scores[i] <= 0:               # bỏ doc không khớp từ khóa nào
                continue
...
class DenseSearch:
    ...
    def index(self, chunks: list[dict], collection: str = COLLECTION_NAME) -> None:
        ...
        # Tạo lại collection sạch (create_collection + delete — recreate_collection đã deprecated)
    ...
    def search(self, query: str, top_k: int = DENSE_TOP_K, collection: str = COLLECTION_NAME) -> list[SearchResult]:
        ...
        return [
            SearchResult(text=pt.payload.get("text", ""), score=pt.score,
